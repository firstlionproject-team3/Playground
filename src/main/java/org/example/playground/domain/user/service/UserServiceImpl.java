...
import static org.example.playground.domain.user.dto.OAuth2ResponseForJWT.oAuth2ResponseFromUser;
...
public class UserServiceImpl implements UserService{
    ...
    public OAuth2ResponseForJWT handleOAuthLogin(OAuthUserInfo info) {
        User user = findOAuthUser(info)
                .orElseGet(() -> registerOAuthUser(info));   // 가입
